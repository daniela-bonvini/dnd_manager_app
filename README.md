...
An app to manage d&amp;d inventory

# General description of the project

This is a React+TypeScript app to keep track of a user's inventory for managing their money and equipment in-game, allowing the user to add items and sell them.
...
To modify the user's equipment, one can click either the buy or sell button at the bottom of the page. They both open a modal that shows cards of items with their name and cost. At the top of the modal, the current money is tracked. When a user clicks on a card, that item is immediately added to or removed from the equipment list, and the current money is updated accordingly. In the sell modal, I also decided to add a "selling sound" just for fun and flair, but I also included the option to disable the sound and saved this choice in local storage to be loaded at the start of the application.
...
Some nice features that I didn't have time to implement:

- Select all checkbox to sell all items in inventory
- Searchbar for items to buy
- Accessibility implementation and more adaptability to small screens
- Dark theme toggle
- Ascendent/descendent ordering in items to buy, choosing by different parameters like name, cost
